...
> If it can break, he'll find out how. Especially the timing-sensitive stuff.
...
**I don't handle:** Core engine implementation (Kaylee), MIDI hardware integration (Wash), synth engine work (Inara), architecture decisions (Mal).
